  ...
  return (
    <div className="min-h-screen bg-gray-100 print:bg-white flex items-start justify-center py-12 px-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200 print:shadow-none print:border-none">

          {/* Faixa verde topo */}
          <div className="h-2 bg-gradient-to-r from-emerald-600 to-emerald-400" />

          {/* Carimbo QUITADO — só visível quando pago */}
          {isPaid && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
              <div
                className="border-[6px] border-emerald-500/20 text-emerald-500/20 text-5xl font-black uppercase tracking-[0.4em] px-10 py-5 rounded-2xl"
          ...
          <div className="px-10 py-6 border-b border-dashed border-gray-200">
            ...
            <div className="flex justify-between items-start gap-8">
              ...
              <p className="text-base font-semibold text-gray-900 shrink-0">{amount}</p>
            </div>
          </div>
