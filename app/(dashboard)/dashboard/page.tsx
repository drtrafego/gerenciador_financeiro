...
export default async function DashboardPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Mesma barra de período do fluxo de caixa */}
      <PeriodBar from={from} to={to} />

      {/* O caixa do período. "Recebido" é o que entrou de verdade: transação
          lançada mais honorário com pagamento confirmado. O que ainda não entrou
          fica no card ao lado, em vez de inflar o primeiro número. */}
      <DashboardMetrics
